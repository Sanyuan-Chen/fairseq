...
class MixRawAudioDataset(FairseqDataset):
    def __init__(
        self,
        sample_rate,
        ...
        **mask_compute_kwargs,
        ...
        logger.info(
            f"mixing_max_len=T // {mixing_max_len}, mixing_prob={mixing_prob},  mixing_num={mixing_num}, "
            f"mixing_noise={mixing_noise}, mixing_noise_prob={mixing_prob} * {mixing_noise_prob} = {mixing_prob * mixing_noise_prob},  mixing_noise_num={mixing_noise_num}, "
    ...
    def collater(self, samples):
        ...
        if self.mixing_prob > 0:
            clean_sources = collated_sources.clone()
            collated_sources = self.mixing_collated_audios(collated_sources)

        input = {"source": collated_sources, "clean_source": clean_sources}
...
class MixFileAudioDataset(MixRawAudioDataset):
    def __init__(
        self,
        manifest_path,
        sample_rate,
        ...
        **mask_compute_kwargs,
        ...
        super().__init__(
            ...
            mixing_max_len=mixing_max_len,
            mixing_prob=mixing_prob,
            mixing_num=mixing_num,
            mixing_noise=mixing_noise,
            mixing_noise_prob=mixing_noise_prob,
            mixing_noise_num=mixing_noise_num,
...
class MixBinarizedAudioDataset(MixRawAudioDataset):
    def __init__(
        self,
        data_dir,
        split,
