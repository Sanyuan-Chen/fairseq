...
from fairseq.data import MixBinarizedAudioDataset, MixFileAudioDataset
...
@dataclass
class MixAudioPretrainingConfig(FairseqDataclass):
    ...
    mixing_noise: bool = field(
        default=False, metadata={"help": "mixing_noise"}
    )
...
@register_task("mix_audio_pretraining", dataclass=MixAudioPretrainingConfig)
class MixAudioPretrainingTask(FairseqTask):
    """ """

    cfg: MixAudioPretrainingConfig

    @classmethod
    def setup_task(cls, cfg: MixAudioPretrainingConfig, **kwargs):
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            self.datasets[split] = MixBinarizedAudioDataset(
                data_path,
                split=split,
            ...
            self.datasets[split] = MixFileAudioDataset(
